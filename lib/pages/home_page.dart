...
class _HomePageState extends State<HomePage> {
  ...
  setupAlan() {
    AlanVoice.addButton(
        "f3dcaabe74b08d6f58a4093595b55f142e956eca572e1d8b807a3e2338fdd0dc/stage",
    ...
    return Scaffold(
      ...
      body: Stack(children: [
        ...
        [
          AppBar(
            title: "AI Radio".text.xl4.bold.white.make().shimmer(
                primaryColor: Color.fromARGB(255, 1, 0, 85),
                secondaryColor: Colors.white),
            backgroundColor: Colors.transparent,
            elevation: 0.0,
            centerTitle: true,
          ).h(100).p16(),
          "Start with - Hey Alan".text.italic.semiBold.make(),
          10.heightBox,
          VxSwiper.builder(
        ...
        Align(
          ...
          child: [
            if (_isPlaying)
              "Radio is Playing Now - ${_selectedRadio.name} FM"
                  .text
                  .white
                  .makeCentered(),
            Icon(
      ...
      ], fit: StackFit.expand, clipBehavior: Clip.antiAlias),
    );
  }
}
